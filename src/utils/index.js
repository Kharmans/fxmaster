...
export {
  ...
  clearTokenRulerGridHighlights,
  installTileRefreshStateGuard,
  installTokenRulerGridHighlightGuard,
  installCanvasPanAfterHook,
  getCanvasLevel,
  getSceneLevelTexturePlan,
  clearSceneLevelTexturePlanCache,
  getConfiguredLevelImagePaths,
  addConfiguredLevelImagePaths,
  getLevelIdsForConfiguredImagePaths,
  getSceneSurfaces,
  sceneHasSurfaces,
...
export {
  surfaceDefinesVisualLevelFootprint,
  surfaceElevationMatchesLevelFootprint,
  getDefinedSurfaceFootprintRegionsForLevel,
} from "./level-surfaces.js";
...
export {
  ...
  fxmGetLevelBackground,
  fxmGetLevelForeground,
  fxmGetLevelTextures,
  fxmGetLevelElevationWindow,
  fxmLevelBottom,
  fxmLevelTop,
  fxmLevelIsAbove,
  fxmLevelIsView,
  ...
  fxmGetRegionBehaviorValue,
  fxmGetRegionBehaviorGateMode,
  fxmGetRegionBehaviorTokenTargets,
  fxmGetRegionBehaviorGMAlwaysVisible,
  fxmGetRegionBehaviorEdgeFadePercent,
  fxmGetRegionBehaviorEventGate,
  fxmReadRegionBehaviorRuntimeState,
  fxmRegionBehaviorRuntimeSignature,
  fxmGetRegionBehaviorEffectDefinitions,
